# TODO Single Access Design Pattern
# Welcome!
...
@[Luke, how many stars are there in these galaxies?]({ "stubs": ["universe.ts"], "command": "node_modules/typescript/bin/tsc universe.ts && node_modules/mocha/bin/mocha universe.spec.js --reporter list" })
